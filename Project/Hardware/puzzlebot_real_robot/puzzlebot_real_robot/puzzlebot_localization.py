import puzzlebot_real_robot.utils.puzzlebot_kinematics as puzzlebot_kinematics
import numpy as np
import rclpy
...
class Localization(Node):
    def __init__(self):
        ...
        self.covariance_matrix = np.eye(3) * 0.01  #self.covariance_matrix = np.zeros((3, 3)) original
